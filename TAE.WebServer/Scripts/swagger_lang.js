...
var SwaggerTranslator = (function () {
    ...
    return {
        Translator: function () {
            ...
            $(document.getElementsByName("parameterContentType")).addClass("form-control input-sm")
            $(".parameter.required").addClass("form-control input-sm")
            $(".body-textarea.required").addClass("form-control")
            $(".response_hider").addClass("btn btn-danger btn-sm")
            //设置控制器描述
